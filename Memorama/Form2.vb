...
Public Class Dificil
    ...
    Private Sub LlenarImagenes()
        ...
        ColocarImagen(PictureBox15)

        ColocarImagen(PictureBox16)

        ColocarImagen(PictureBox17)

        ColocarImagen(PictureBox18)
